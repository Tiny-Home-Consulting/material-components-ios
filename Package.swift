...
let unusedComponents: [String] = [
    "ActionSheet", "ActivityIndicator", "AppBar", "Badges", "Banner",
    ...
    "List", "M3CButton", "M3CTextField", "MinimumOS", "NavigationBar",
    "NavigationDrawer", "OverlayWindow", "PageControl", "Palettes",
    "ProgressView", "ScalableFontDescriptor", "SegmentedControl", "Slider",
    "Snackbar", "Tabs", "TextFields", "Themes",
]
...
let usedComponentSubdirExcludes: [String] = [
    ...
    "components/Buttons/tests",
    "components/Buttons/docs",
    "components/Cards/examples",
    "components/Cards/tests",
    "components/Cards/docs",
    "components/TextControls/examples",
    "components/TextControls/tests",
    "components/TextControls/docs",
    "components/Elevation/tests",
    "components/Ink/examples",
    "components/Ink/tests",
    "components/Ink/docs",
    "components/Ripple/examples",
    "components/Ripple/tests",
    "components/Ripple/docs",
    "components/Shadow/examples",
    "components/Shadow/tests",
    "components/ShadowElevations/examples",
    "components/ShadowElevations/tests",
    "components/ShadowElevations/docs",
    "components/ShadowLayer/examples",
    "components/ShadowLayer/tests",
    "components/ShadowLayer/docs",
    "components/Shapes/tests",
    "components/Shapes/docs",
    "components/ShapeLibrary/tests",
    "components/ShapeLibrary/docs",
    "components/Typography/examples",
    "components/Typography/tests",
    "components/Typography/docs",
    "components/Color/tests",
    "components/schemes/Color/tests",
    "components/schemes/Color/docs",
    "components/schemes/Container/tests",
    "components/schemes/Shape/tests",
    "components/schemes/Shape/docs",
    "components/schemes/Typography/examples",
    "components/schemes/Typography/tests",
    "components/schemes/Typography/docs",
...
let sourceDirs: [String] = [
    ...
    "components/Typography/src/FontScaler",
...
let package = Package(
    ...
    targets: [
        .target(
            ...
            sources: sourceDirs,
            publicHeadersPath: "SPM/PublicHeaders",
            cSettings: [
                ...
                .headerSearchPath("components/Color/src"),
